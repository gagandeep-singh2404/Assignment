...
//                              price ) );
    ...
    public String getNextOrder() {
        return orderQueue.take().toString();
    }
    ...
    private void procedingOrder() {
        Order order = orderQueue.take();
        int orderNR = order.getNumber();
        for (OrderLine ol : order) {
            this.addReadyMealToQueue(ol, orderNR);
        }
    }

    private void addReadyMealToQueue(OrderLine ol, int orderNR) {
