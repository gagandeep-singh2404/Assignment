...
//                                price ) );
     ...
     */
    public synchronized int submitOrder(String... ordered) throws RestaurantException {
        orderCount++;
    ...
    private synchronized void putOrder(Order order) {
        orderQueue.put(order);
    }
    
    private synchronized Order getCurrentOrder(){
        return orderQueue.get();
    }
    
    private synchronized void putCurrentMeal(int orderNR, int mealNR){
