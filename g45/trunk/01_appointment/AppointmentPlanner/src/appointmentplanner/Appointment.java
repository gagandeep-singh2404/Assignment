...
public final class Appointment implements Comparable<Appointment> {
    ...
    public int compareTo(Appointment o) {
        Appointment compareToAppointment = (Appointment) o;

        if (this.priority.getPriority() < o.priority.getPriority()) {
            return -1;
        } else if (this.priority.getPriority() == o.priority.getPriority()) {
            return 0;
        } else {
            return 1;
        }
