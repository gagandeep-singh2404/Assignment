...
public class TimeSpan {
    ...
    public TimeSpan(Time from, Time to) {
        ...
        // call getProperTime Method to get a valid span 
    ...
    public void addTimeSpan(TimeSpan timeSpan) {
        //TODO
        this.span = Time.getProperTime(0, this.getTimeSpanInMinutes() + timeSpan.getTimeSpanInMinutes());
    }
