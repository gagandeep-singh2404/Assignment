...
public class HeapSorter<E> implements Sort<E> {
    ...
    /**
     * compare the items of firstNode and secondNode 
     * @param firstNode first Node 
     * @param secondNode second Node
     * @return  true if firsttNode item is smaller than secondNode item
     */
    private boolean less(Node<E> firstNode, Node<E> secondNode) {
        return com.compare(firstNode.item, secondNode.item) < 0;
    }
    ...
    /**
     *  exchange firstNode item with secondNode item
     * @param firstNode
     * @param secondNode 
     */
    private void exchangeItems(Node<E> firstNode, Node<E> secondNode) {
